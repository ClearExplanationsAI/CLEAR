    ...
    def explain_instance(self,
        ...
        if CLEAR_settings.LIME_comparison: 
            ...
            if CLEAR_settings.case_study ==  'Credit Card':  
                ...
                temp.rename(columns={'eduDd':'eduDd0', 'marDd':'marDd0','PAY':'PAY0'}, inplace=True)
                if len(temp.columns) !=33:
            ...
            if CLEAR_settings.case_study ==  'Census':  
                ...
                temp.rename(columns={'marDd1':'marDdmarried', 'marDd2':'marDdnotmarried'}, inplace=True)
...
#me
            if CLEAR_settings.LIME_comparison== True:
                ...
                if label ==0:
                    export_data = [label,yss[0][0],data_row,ret_exp.local_exp[label],ret_exp.local_pred[0]]
                    with open('Label0_LIME_Iris.csv','a', newline='') as f:
                        writer = csv.writer(f)
                        writer.writerow(export_data)
